...
// reason was passed in. $slot$  -- The target slot $namelogId$ -- The target namelog ID. You
// probably want the slot, not this. See dist/configs/game/admin.dat for examples of votes.
